...
function JobOpeningLinksTab() {
  ...
  const responseFields = [
    ...
    { name: "area", type: "string | null", description: "Área da vaga (Comercial, Marketing, TI, etc.)" },
    { name: "job_type", type: "string | null", description: "Tipo do cargo (SDR, Closer, Analista, etc.)" },
    ...
    { name: "differentials", type: "string | null", description: "Diferenciais desejados" },
    { name: "seniority", type: "string | null", description: "Senioridade (Júnior, Pleno, Sênior, etc.)" },
    { name: "contract_model", type: "string | null", description: "Modelo contratual (CLT, PJ, Comissão, etc.)" },
    ...
    { name: "is_remote", type: "boolean", description: "Se a vaga é remota" },
    { name: "status", type: "string", description: '"open" | "in_progress" | "paused" | "closed"' },
    { name: "application_url", type: "string", description: "Link público para candidatura (página de formulário)" },
    { name: "target_date", type: "date | null", description: "Data alvo para preenchimento" },
    { name: "sla_days", type: "number | null", description: "SLA em dias" },
  ...
  "data": [
    {
      ...
      "differentials": "Experiência com CRM e metodologia SPIN",
      "seniority": "Sênior",
      "contract_model": "CLT",
