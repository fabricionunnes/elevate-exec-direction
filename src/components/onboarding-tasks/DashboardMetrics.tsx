      ...
      <Tabs defaultValue="empresas" className="w-full" onValueChange={(value) => {
        ...
        <TabsContent value="empresas" className="mt-2 sm:mt-3 space-y-2 sm:space-y-3">
          <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-9 gap-1.5 sm:gap-2">
            ...
            <Card className={cn("cursor-pointer hidden sm:block", isCardActive("contracts", "renewed") && "ring-2 ring-emerald-500")} onClick={() => handleCardClick("contracts", "renewed")}><CardContent className="p-2 sm:p-3 text-center"><p className="text-lg sm:text-xl font-bold text-emerald-500">{renewalMetrics.renewedPercent}%</p><p className="text-[9px] sm:text-[10px] text-muted-foreground">Renovados ({renewalMetrics.renewalsCount})</p></CardContent></Card>
