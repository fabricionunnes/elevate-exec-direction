      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-muted rounded-full mb-4">
            ...
            <span className="text-sm text-foreground/80">Segurança e Controle de Acesso</span>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {profiles.map((profile, index) => (
            ...
            >
              ...
              <h3 className="text-foreground font-semibold mb-1">{profile.name}</h3>
        ...
        <motion.div
          ...
          className="mt-12 p-6 bg-muted/50 border border-border rounded-xl text-center"
        >
          <p className="text-foreground/80">
            <strong className="text-primary">Isolamento de dados:</strong> Cada empresa e usuário 
