...
export default function FAQPage() {
  return (
    <Layout>
      ...
      <section className="section-padding bg-secondary"><div className="container-premium"><div className="card-premium p-8 lg:p-12 text-center max-w-3xl mx-auto"><h2 className="heading-card text-foreground mb-4">Ainda tem dúvidas?</h2><p className="text-body mb-6">Aplique para um diagnóstico e nossa equipe responderá qualquer pergunta específica sobre sua situação.</p><div className="flex flex-col sm:flex-row gap-4 justify-center"><Link to="/apply"><Button variant="premium" size="lg">Aplicar para Diagnóstico</Button></Link></div><p className="mt-6 text-sm text-muted-foreground">Contato (WhatsApp): <span className="text-foreground font-medium">(31) 99912-0003</span></p></div></div></section>
    </Layout>
  );
}
