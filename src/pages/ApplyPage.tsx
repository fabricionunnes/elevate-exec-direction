        ...
        <div className="container-premium"><div className="max-w-2xl mx-auto">
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <Button type="submit" variant="premium" size="xl" className="w-full" disabled={submitting}>{submitting ? <><Loader2 className="mr-2 h-5 w-5 animate-spin" />Enviando...</> : <>Enviar Aplicação<ArrowRight className="ml-2" /></>}</Button>
            </form>
          ) : (
