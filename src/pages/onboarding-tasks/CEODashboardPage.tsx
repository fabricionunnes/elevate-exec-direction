        ...
        <Tabs defaultValue="ai" className="space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border p-2">
            <ScrollArea className="w-full">
              <TabsList className="inline-flex h-auto gap-1 bg-transparent p-0 w-max min-w-full">
                {mainTabs.map((tab) => (
                  <TabsTrigger 
                    key={tab.value}
                    value={tab.value} 
                    className="gap-2 px-4 py-2.5 rounded-lg data-[state=active]:bg-slate-900 data-[state=active]:text-white data-[state=active]:shadow-md transition-all whitespace-nowrap"
                  >
                ...
                {/* Divider */}
                <div className="w-px h-8 bg-slate-300 mx-2 self-center flex-shrink-0" />
                ...
                {secondaryTabs.map((tab) => (
                  <TabsTrigger 
                    key={tab.value}
                    value={tab.value} 
                    className="gap-1.5 px-3 py-2 rounded-lg text-slate-600 hover:text-slate-900 data-[state=active]:bg-slate-100 data-[state=active]:text-slate-900 transition-all text-sm whitespace-nowrap"
                  >
