    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      <div className="space-y-6 p-4 sm:p-6 max-w-[1600px] mx-auto">
        ...
        <Tabs defaultValue="ai" className="space-y-4">
          ...
          <div className="bg-card rounded-xl shadow-sm border p-3">
            <TabsList className="flex flex-wrap h-auto gap-1.5 bg-transparent p-0 w-full justify-start">
              ...
              {mainTabs.map((tab) => (
                <TabsTrigger
                  key={tab.value}
                  value={tab.value}
                  className="gap-2 px-4 py-2.5 rounded-lg data-[state=active]:bg-foreground data-[state=active]:text-background data-[state=active]:shadow-md transition-all"
                >
              ...
              {secondaryTabs.map((tab) => (
                <TabsTrigger
                  key={tab.value}
                  value={tab.value}
                  className="gap-1.5 px-3 py-2 rounded-lg text-muted-foreground hover:text-foreground data-[state=active]:bg-accent data-[state=active]:text-accent-foreground transition-all text-sm"
                >
