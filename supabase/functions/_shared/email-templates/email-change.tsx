...
export const EmailChangeEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Confirme a alteração do seu e-mail — Universidade Nacional de Vendas</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            Você solicitou a alteração do seu e-mail na Universidade Nacional de Vendas de{' '}
