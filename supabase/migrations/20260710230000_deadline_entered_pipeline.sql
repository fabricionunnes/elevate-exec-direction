-- Deadline de fechamento = tempo do lead ENTRAR NO FUNIL até dar ganho (não da criação).
-- Troca l.created_at por COALESCE(l.entered_pipeline_at, l.created_at) na média de dias.
...
BEGIN
  ...
  -- Deadline: da ENTRADA NO FUNIL (entered_pipeline_at) até o fechamento ganho
