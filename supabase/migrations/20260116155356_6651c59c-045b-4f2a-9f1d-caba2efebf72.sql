-- Fix notify_candidate_created(): onboarding_users does not have is_active
...
BEGIN
  ...
  -- NOTE: onboarding_users does not have is_active
  FOR v_user IN
...
-- Ensure trigger still points to the updated function
