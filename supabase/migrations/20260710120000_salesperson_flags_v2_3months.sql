-- Flags v2: 3 últimos meses fechados (em julho: junho, maio, abril) — uma linha
-- por vendedor×mês. Regra por mês: <70% = Red · 70–100% = Yellow · >100% = Green.
-- Guard também aceita service_role (o resumo-diario-gestao usa no fechamento
-- mensal do dia 1º nos grupos de gestão).
...
language sql stable security definer set search_path = public as $$
  ...
  targets as (
    select m.my, t.salesperson_id sid, t.kpi_id, sum(t.target_value) target
