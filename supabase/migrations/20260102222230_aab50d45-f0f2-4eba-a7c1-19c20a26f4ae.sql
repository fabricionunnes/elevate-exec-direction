-- Fix recurring tasks: create DB trigger, respect project/contract active, and avoid task_history constraint errors
...
-- Trigger to generate next recurring task when marking completed
DROP TRIGGER IF EXISTS onboarding_tasks_create_next_recurring_task ON public.onboarding_tasks;
CREATE TRIGGER onboarding_tasks_create_next_recurring_task
