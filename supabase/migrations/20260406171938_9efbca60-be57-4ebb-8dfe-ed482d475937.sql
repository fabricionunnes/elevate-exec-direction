...
BEGIN
  ...
  LOOP
    ...
    FOREACH v_secondary_id IN ARRAY v_group.secondary_ids LOOP
      ...
      -- Move related data to primary
      UPDATE crm_activities SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_meeting_events SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_lead_form_answers SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_sales SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_forecasts SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_lead_history SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_transcriptions SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_lead_summaries SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_lead_files SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;
      UPDATE crm_whatsapp_contacts SET lead_id = v_group.primary_id WHERE lead_id = v_secondary_id;

      -- Delete secondary lead and its tags
